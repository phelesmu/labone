...
public class my_frame extends JPanel{
    ...
    private ArrayList<Integer> w = new ArrayList<Integer>(); //权值 
    ...
    public my_frame( ArrayList<posi> draw ,ArrayList<String> str,ArrayList<posi> draw_edge,ArrayList<Integer> w) {
    	this.draw = draw;
    	this.str = str;
    ...
    public void set( ArrayList<posi> draw ,ArrayList<String> str,ArrayList<posi> draw_edge,ArrayList<Integer> w) {
    	this.draw = draw;
    	this.str = str;
    	this.draw_edge = draw_edge;
    	this.w = w;
